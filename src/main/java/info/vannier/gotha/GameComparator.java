    ...
    public int compare(Game g1, Game g2){
        ...
        switch (gameOrderType){
            case TABLE_NUMBER_ORDER :
                ...
                else if (g1.getBoard() > g2.getBoard()) return 1;
                else return 0;
...
//                else return -1;
            case BEST_MMS_ORDER :
                ...
                int wMMS1 = wSP1.getCritValue(PlacementCriterion.MMS, g1.getRound() -1);
                int bMMS1 = bSP1.getCritValue(PlacementCriterion.MMS, g1.getRound() -1);
                ...
                int wMMS2 = wSP2.getCritValue(PlacementCriterion.MMS, g2.getRound() -1);
                int bMMS2 = bSP2.getCritValue(PlacementCriterion.MMS, g2.getRound() -1);
