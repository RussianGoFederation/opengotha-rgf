 ...
 **/
class ScoredPlayerComparator implements Comparator<ScoredPlayerReference>, Serializable{
    ...
    @Override
    public int compare(ScoredPlayerReference sP1, ScoredPlayerReference sP2) {
    ...
    public int betterByScore(ScoredPlayerReference sP1, ScoredPlayerReference sP2) {
